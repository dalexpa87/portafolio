...
<div class="section" id="noti">
  ...
  <h5 class="center" >Entérate</h5>
    <div class="col s3">
      <div class="card">
        <div class="card-image">
          <a href=""><img width="100%" src="img/Noticia1.jpg">
    ...
    <div class="card">
       <div class="card-image">
          <a href=""><img width="100%"  src="img/Noticia2.jpg">
          <span class="card-title">Card Title</span></a>
        </div>
      </div>
    </div>
    <div class="col s3">
       <div class="card">
        <div class="card-image">
          <a href=""><img width="100%"  src="img/Noticia3.jpg">
          <span class="card-title">Card Title</span></a>
        </div>
      </div>
    </div>
    ...
    <div class="col s3">
       <div class="card">
        <div class="card-image">
          <a href="">><img width="100%"  src="img/Noticia4.jpg">
          <span class="card-title">Card Title</span></a>
        </div>
      </div>
    </div>
